...
/*********************************************************************************
 ...
 Others:        //
*********************************************************************************/
CPU_INT32U  BSP_GET_CPU_ClkFreq (void)
{
...
void  CPU_TS_TmrInit (void)
{
 ...
 cpu_clk_freq_hz = BSP_GET_CPU_ClkFreq();
...
/*********************************************************************************
 ...
 Others:        //
**********************************************************************************/
void  EXTI15_10_FUN( void )
{
 OS_ERR err;
 unsigned long itemp;
 extern OS_TCB Enc28j60_input_thread_TCB;
 itemp = EXTI->PR;
 if(itemp & (1ul << 10))
 {
  EXTI->PR |= 1ul << 10;
  OSTaskSemPost (&Enc28j60_input_thread_TCB, OS_OPT_POST_NONE, &err);
  bsp_cnt ++;
 }
 if(itemp & (1ul << 11))
 {EXTI->PR |= 1ul << 11;}
